...
The aesthetic and narrative feel of Atomic Adventures.
...
2. **Learn** — Find documents, diagrams, and controls. Understand the technology.
3. **Restore** — Use simulations and mini-games to bring the facility back online.
4. **Unlock** — Success opens a path back to the hub and reveals the next area.
...
- **Light as progress** — Dark/dormant when the player arrives; illuminated and alive once restored
