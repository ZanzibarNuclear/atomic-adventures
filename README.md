...
This repository contains design documentation, story outlines, simulation specifications, and planning materials. Code and assets will be added as the design matures.

## Quick Links

- [Project Structure](docs/project-structure.md) — How this project is organized
- [Game Design Overview](design/docs/game-design-overview.md) — Core vision, pillars, and scope
- [Story & Narrative](design/docs/story-overview.md) — Beginning storyline and narrative design
- [Simulation Specifications](design/tech/) — Physics and engineering simulation designs
