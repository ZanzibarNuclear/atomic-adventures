...
describe('west bank direct moves', () => {
  ...
  it('steps into a safe stand in the west-side area of lower-gorge', () => {
  ...
  it('offers lower-gorge from west bank at upper-gorge', () => {
    ...
    expect(directMoves.map((m) => m.toHexId)).toContain('lower-gorge')
  })
