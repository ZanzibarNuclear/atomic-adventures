 ...
 * @returns {any}
 */
export function evaluateHydro(plant_json, operator_json) {
 ...
 * @returns {any}
 */
export function runSession(config_json, duration_secs, commands_json) {
    const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function sessionSnapshot(config_json, start) {
    const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('energy_sim_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
