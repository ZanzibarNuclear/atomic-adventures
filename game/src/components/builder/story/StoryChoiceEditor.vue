...
const props = defineProps({
  ...
  /** Open the full editor when this choice is first shown (e.g. just added). */
...
const editing = ref(Boolean(props.startEditing));
...
function updateSetFlags(value) {
  props.choice.set_flags = Array.isArray(value)
...
<template>
  <article class="choice-editor" :class="{ editing }">
    ...
    <div v-else class="choice-form">
      ...
      <FlagListEditor
        :model-value="choice.set_flags ?? []"
        :flag-ids="flagIds"
        label="Set flags"
        placeholder="story.gate.inspected"
        @update:model-value="updateSetFlags"
      />
      <details>
      ...
      <div class="form-footer">
        <button type="button" class="sm success-btn" @click="editing = false">
